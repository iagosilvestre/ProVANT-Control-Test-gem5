...
extern "C" {
#include "lib/c_control_Hinfload.c"
#include "lib/c_control_Hinfload.h"
...
//		iInputData.position.dotZ = pos_ref.dotZ;
		...
		printf("-------------------------------------------------------------------------");
		printf("\n\n escRightNewtons = %f",oControlOutputData.actuation.escRightNewtons);
		printf("\n escLeftNewtons = %f",oControlOutputData.actuation.escLeftNewtons);
		printf("\n servoRight = %f",oControlOutputData.actuation.servoRight);
		printf("\n servoLeft = %f",oControlOutputData.actuation.servoLeft);
		printf("\n escRightSpeed = %f",oControlOutputData.actuation.escRightSpeed);
		printf("\n escLeftSpeed = %f",oControlOutputData.actuation.escLeftSpeed);
		printf("\n refX = %f",pos_ref.x);
		printf("\n refY = %f",pos_ref.y);
		printf("\n refZ = %f",pos_ref.z);
		printf("\n dot.refX = %f",pos_ref.dotX);
		printf("\n dot.refY = %f",pos_ref.dotY);
		printf("\n dot.refZ = %f",pos_ref.dotZ);
